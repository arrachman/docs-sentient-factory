* **1. Foundation & Strategy (Landasan Proyek)**
  * [Overview](README.md)
  * [🚀 Marketing Pitch](marketing.md)
...
* **2. Phase 1 & 2: Analysis & Architecture (Analisa)**
...
* **4. Phase 4: Development (Implementasi)**
  * **A. Backend & Core**
  ...
  * **B. AI Services**
    ...
    * [🖥️ AI Setup (Mac M4)](ai-setup.md)
    * [☁️ AI Setup (Gemini)](ai-gemini.md)
  ...
  * **C. Frontend**
    ...
    * [📦 Metronic v9.3.7 Reference](metronic-reference.md)
...
* **5. Phase 5: Testing (Validasi)**
  ...
  * [**🎭 E2E Testing (Playwright)**](qa.md#_8-e2e-testing-playwright)
  * [Performance Testing](qa.md#_9-performance-testing)
  * [📚 Storybook](storybook.md)

* **6. Phase 6: Deployment & Operations (Rilis)**
